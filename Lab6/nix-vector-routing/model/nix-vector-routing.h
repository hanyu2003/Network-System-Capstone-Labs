...
public:
  ...
  /** NEW: 由 helper 呼叫，從檔案讀取所有 SD-pair 路徑 *////////////////////////////
  void SetPaths (const std::string &pathFile);
  /** NEW: 路徑表: key=(src,dst), value=節點列表 */
  std::map<std::pair<int,int>, std::vector<int>> m_table;
  /////////////////////////////////////////////////////////////////////////////////
